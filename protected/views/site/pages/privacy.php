...
<ul>
			...
			<li>Ex&eacute;cution de la commande
</li>
			<li>Partenariat
</li>
...
<p>
	...
	y opposer au moment de la collecte (en ne renseignement pas les champs des formulaires et en n'effectuant pas de transaction) ou &agrave; tout moment par la suite, comme mentionn&eacute; dans la section suivante.
</p><hr/>
...
<p>
	...
	Adresse postale : 5412 Avenue du Parc, Montreal H2V 4G7<br />	Courriel : support@kle-en-main.com<br />	T&eacute;l&eacute;phone : 514-303-5667<br />		</p><hr/>
...
<p>
	...
	<ul>
									<li>Protocole SSL (Secure Sockets Layer) pour les transactions entre nos serveurs</li>
												<li>Gestion des acc&egrave;s - personne autoris&eacute;e &amp; concernée</li>
...
<?php elseif (Yii::app()->language === "en"): ?>
	...
	<p>Email marketing: With your permission, we may send you emails about our store, new products and other updates. You may unsubscribe from non-transactional emails at any time by following the 'Unsubscribe' link at the bottom of these emails.</p>
	...
	<p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at support@kle-en-main.com or mailing us at: 4032471 Canada Inc. 5412 Park Avenue Montreal Quebec Canada H2V 4G7</p>
	...
	<p>Your data is stored through KEM&rsquo;s data storage, databases and the general KEM application. They store your data on a secure server behind a firewall.</p>

	

	<p class="strong">Payment:</p>

	<p>If you choose a direct payment gateway to complete your purchase, then Stripe&trade; stores your credit card data. It is encrypted through the Payment Card Industry Data Security Standard (PCI-DSS). Your purchase transaction data is stored only as long as is necessary to complete your purchase transaction. After that is complete, your purchase transaction information is deleted. KEM or <?php Yii::app()->name; ?> do not have access to your credit card data.</p>
	...
	<p>We use unique cookies and session tokens to store information about your session (referrer, authentication, landing page, etc). The data collected by these cookies is essential to the store's core functionalities as well as internal stats, analytics, etc.</p>
	...
	<p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at support@kle-en-main.com or by mail at 4032471 Canada Inc.</p>

	<p>[Re: Privacy Compliance Officer]</p>

	<p>[5412 Park Avenue Montreal Quebec Canada H2V 4G7] </p>
