 ...
 *
 * The followings are the available columns in table 'product_has_category':
 * @property integer $product_id
 * @property integer $category_id
 */
class ProductHasCategory extends CActiveRecord
{
	/**
	 ...
	 * @return ProductHasCategory the static model class
	 */
